...
var findPositionOfCapturingGroup = function findPositionOfCapturingGroup(
  markup,
  parameterName
) {
  invariant(
...
var iterateMentionsMarkup = function iterateMentionsMarkup(
  value,
  config,
  markupIteratee
) {
  var textIteratee =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : emptyFn
  var regex = combineRegExps(
...
var mapPlainTextIndex = function mapPlainTextIndex(
  value,
  config,
  indexInPlainText
) {
  var inMarkupCorrection =
  ...
  var textIteratee = function textIteratee(
    substr,
    index,
    substrPlainTextIndex
  ) {
  ...
  var markupIteratee = function markupIteratee(
    markup,
    index,
...
var applyChangeToValue = function applyChangeToValue(
  value,
  plainTextValue,
  _ref,
  config
...
var findStartOfMentionInPlainText = function findStartOfMentionInPlainText(
  value,
  config,
  indexInPlainText
) {
...
function createDefaultStyle(defaultStyle, getModifiers) {
  var enhance = function enhance(ComponentToWrap) {
    var DefaultStyleEnhancer = /*#__PURE__*/ React__default.forwardRef(function(
      _ref,
      forwardedRef
    ) {
...
function Highlighter(_ref) {
  ...
  var mentionIteratee = function mentionIteratee(
    markup,
    index,
    indexInPlainText,
    id,
  ...
  var getMentionComponentForMatch = function getMentionComponentForMatch(
    id,
    display,
    mentionChildIndex,
    key
...
function SuggestionsOverlay(_ref) {
  ...
  React.useEffect(
    function() {
      ...
      var _ulElement$children$f = ulElement.children[
          focusIndex
  ...
  var renderSuggestions = function renderSuggestions() {
    var suggestionsToRender = Object.values(suggestions).reduce(function(
      accResults,
      _ref2
    ) {
  ...
  var renderSuggestion = function renderSuggestion(result, queryInfo, index) {
    ...
    var renderSuggestion = React.Children.toArray(children)[childIndex].props
      .renderSuggestion
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), 'getInputProps', function() {
      ...
      return _objectSpread(
        _objectSpread(
          _objectSpread(_objectSpread({}, props), style('input')),
          {},
          {
    ...
    _defineProperty(_assertThisInitialized(_this), 'renderTextarea', function(
      props
    ) {
      return /*#__PURE__*/ React__default.createElement(
        'textarea',
    ...
    _defineProperty(
      ...
      function() {
        ...
        var suggestionsNode = /*#__PURE__*/ React__default.createElement(
    ...
    _defineProperty(_assertThisInitialized(_this), 'executeOnChange', function(
      event
    ) {
      for (
        var _len = arguments.length,
      ...
      if (_this.props.onChange) {
        ...
        return (_this$props4 = _this.props).onChange.apply(
          _this$props4,
          [event].concat(args)
        )
      }
    ...
    _defineProperty(_assertThisInitialized(_this), 'handleChange', function(
      ...
      var newValue = applyChangeToValue(
        value,
        newPlainTextValue,
        {
      ...
      var startOfMention = findStartOfMentionInPlainText(
        value,
        config,
        selectionStart
      )
    ...
    _defineProperty(_assertThisInitialized(_this), 'selectFocused', function() {
      ...
      var _Object$values$reduce = Object.values(suggestions).reduce(function(
          acc,
          _ref
        ) {
          var results = _ref.results,
    ...
    _defineProperty(
      ...
      function() {
        ...
        if (
          ...
          position.position === _this.state.suggestionsPosition.position
        ) {
          return
        }
    ...
    _defineProperty(
      ...
      function(plainTextValue, caretPosition) {
        ...
        var config = readConfigFromChildren(children)
        var positionInValue = mapPlainTextIndex(
          value,
          config,
          caretPosition,
          'NULL'
        ...
        var substring = plainTextValue.substring(
          substringStartIndex,
          caretPosition
    ...
    _defineProperty(_assertThisInitialized(_this), 'addMention', function(
      ...
      var value = _this.props.value || ''
      var config = readConfigFromChildren(_this.props.children)
      var mentionsChild = React.Children.toArray(_this.props.children)[
        childIndex
      ]
      ...
      var newPlainTextValue = spliceString(
        plainTextValue,
        querySequenceStart,
        querySequenceEnd,
        displayValue
    ...
    _defineProperty(_assertThisInitialized(_this), 'isOpened', function() {
      return (
        ...
        (countSuggestions(_this.state.suggestions) !== 0 || _this.isLoading())
      )
    })
  ...
  _createClass(MentionsInput, [
    ...
    },
    {
      ...
      value: function handlePaste(event) {
        ...
        var config = readConfigFromChildren(children)
        var markupStartIndex = mapPlainTextIndex(
          value,
          config,
          selectionStart,
          'START'
        )
        var markupEndIndex = mapPlainTextIndex(
          value,
          config,
          selectionEnd,
          'END'
...
var getComputedStyleLengthProp = function getComputedStyleLengthProp(
  forElement,
  propertyName
) {
